...
def evaluate_guess(guess):
    if params["game_over"]:
        ...
        return '<h2 style="color: #B33771">The game is already over!</h2><p>Access the main page or /reset to reset the game if you want to play again.</p>'
    ...
    if guess < NUM_FROM or guess > NUM_TO:
        ...
        return '<h2 style="color: #58B19F">Too low!</h2><img src="https://media.giphy.com/media/jD4DwBtqPXRXa/giphy.gif" alt="Too low animation">'

    else:
        return '<h2 style="color: #3B3B98">Too high!</h2><img src="https://media.giphy.com/media/73h3LBWraONTW/giphy.gif" alt="Too high animation">'
